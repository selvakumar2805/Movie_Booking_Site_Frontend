...
const AuthForm = ({ onSubmit, isAdmin }) => {
    ...
    const handleChange = (e) => {
        setInputs((prevState) => ({ // prevstate is because when we put email, it will store email as prevstate ater that we can put password 
            ...prevState,
    ...
    return (
        <Dialog PaperProps={{ style: { borderRadius: 20 } }} open={true}>
            ...
            <Box sx={{ ml: "auto", padding: 1 }}>
                <IconButton LinkComponent={Link} to="/"><CloseRoundedIcon /></IconButton>
            </Box>
